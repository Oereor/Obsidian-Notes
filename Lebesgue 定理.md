...
> **记号.** 函数 $f$ 的不连续点的集合记为 $D(f)$. 

> **记号.** 定义函数 $f$ 在邻域 $O(x_0,r)$ 上的振幅 $\omega_f(x_0,r)$ 为 $$\omega_f(x_0,r) = \sup_{x,y\in O(x_0,r)} |f(x)-f(y)|$$ 由单调有界定理, 当 $r\to 0^+$ 时, $\omega_f(x_0,r)$ 一定收敛. 定义 $$\omega_f(x_0) = \lim_{r\to 0^+} \omega_f(x_0,r)$$ 为 $f$ 在 $x_0$ 处的振幅. 
