...
若 $f\in R[a,b]$, 则 $f$ 在 $[a,b]$ 上有界. *注意: 反之不真. 反例: Dirichlet函数.* 
...
> **(Darboux) 下和与上和.** 设 $f$ 在 $[a,b]$ 上有界, 对任意分割 $\pi=\{x_0,x_1,\ldots,x_n\}$, 定义 $f$ 在 $\pi$ 下的下和与上和分别为 $$\underline{S}(f,\pi)=\sum_{k=1}^n m_k\Delta x_k,$$ $$\overline{S}(f,\pi)=\sum_{k=1}^n M_k\Delta x_k.$$ 显然有 $\underline{S}(f,\pi)\le S(f,\pi,\xi)\le \overline{S}(f,\pi)$.

同时有以下引理. 

> 若 $\pi'$ 是 $\pi$ 的一个加细分割 (即加入新的分点, 或者说 $\pi\subset\pi'$), 则 $$\underline{S}(f,\pi)\le \underline{S}(f,\pi'),\qquad\overline{S}(f,\pi')\le \overline{S}(f,\pi).$$ 即 **"上和不增, 下和不减".** 
