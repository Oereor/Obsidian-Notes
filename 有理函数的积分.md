...
1. 求解积分 $\displaystyle\int\frac{x^4-x^3-x^2-3x}{(x^2-1)(x^2+1)}\,dx$. 

2. 求解积分 $\displaystyle\int\frac{1}{x^4+1}\,dx$. 

> **解.** $$\begin{align*}
    \int\frac{1}{x^4+1}\,dx&=\int\frac{\frac{1}{x^2}}{x^2+\frac{1}{x^2}}\,dx\\
    &=-\frac{1}{2}\int\frac{1-\frac{1}{x^2}}{\left( x+\frac{1}{x} \right)^2-2}\,dx+\frac{1}{2}\int\frac{1+\frac{1}{x^2}}{\left( x-\frac{1}{x} \right)^2+2}\,dx\\
    &=-\frac{1}{2}\int\frac{1}{u^2-2}\,du+\frac{1}{2}\int\frac{1}{v^2+2}\,dv
\end{align*}$$ 以后易求. 参考: [[常用积分公式]]